...
def train(training_path_a, training_path_b, max_iter=10, max_items=1000):
    print ("Reading features")
    training_a = read_features_from_csv(training_path_a)
    training_b = read_features_from_csv(training_path_b)
    training_a = training_a[:max_items]
    training_b = training_b[:max_items]
...
if len(sys.argv) == 3:
    ...
    print ("Wrong arguments!\nUsage: python classifier.py features_a.csv features_b.csv [max_iter] [max_item]")
